...
#ifndef OliEQ3FXParams_H
#define OliEQ3FXParams_H
...
static const AkPluginParamID PARAM_GAIN_ID = 0;
...
struct OliEQ3NonRTPCParams
{
};

struct OliEQ3FXParams
    : public AK::IAkPluginParam
{
    OliEQ3FXParams();
    OliEQ3FXParams(const OliEQ3FXParams& in_rParams);
    ...
    OliEQ3RTPCParams RTPC;
    OliEQ3NonRTPCParams NonRTPC;
};

#endif // OliEQ3FXParams_H
